    ...
    public static void addQuestionsToMap(int modus){
        ...
        switch (modus){
            case 1:
                ...
                questionMap.put(5, new Question("Mimik", "Zimmer 013","Was muss man tun, damit die Musik abgespielt wird?", new String[]{"lächeln", "lachen", "smile"}, "Schau nicht so böse..."));
                questionMap.put(6, new Question("Menschen 'scannen'", "Zimmer 013","Welche Eigenschaft muss der erkannte Mensch haben, damit Musik gespielt wird?", new String[]{"alt", "älter", "alte menschen", "greis"}, "Es ist möglich, dass Bilder aus dem Internet in die Kamera gezeigt werden müssen, weil du selbst die Eigenschaft nicht erfüllst..."));
