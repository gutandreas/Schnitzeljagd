    ...
    public static void addQuestionsToMap(int modus){
        ...
        switch (modus){
            ...
            case 5:
                ...
                questionMap.put(3, new Question("Verschlüsselung", "Vor Zimmer 010","Übersetze die folgende Geheimschrift zurück ins Original: Mfkyukqnhmyajwxnhmjwzsl", new String[]{"Haftpflichtversicherung"}, "Alle Buchstaben wurden um 5 Stellen verschoben"));
                questionMap.put(4, new Question("Codierung", "Lichthof","Decodiere das mit ASCII-Code codierte Lösungswort", new String[]{"Abgaben"}, "Zu einem Zeichen gehören immer 7 Bits"));
                questionMap.put(5, new Question("Netzwerke", "Beim Treppenhaus (EG)","Wie viele dieser Angaben hat Tobias selber in ein Eingabefeld auf dem Server eingetippt? Hänge an diese Zahl zudem den Port an, an den man beim Aufruf von «http://www.sbb.ch» einen Get-Request schickt.", new String[]{"380"}, "Schickt man im Browser einen HTTP-Request an eine IP-Adresse ohne eine Portnummer anzugeben, so wird automatisch eine Portnummer ergänzt."));
                ...
                questionMap.put(7, new Question("Big Data", "Heutiges Informatikzimmer","Ordne die Cookies zur passenden Beschreibung. Welche der Beschreibungen passt zu den Performance Cookies? Gib die Nummer der richtigen Beschreibung an.", new String[]{"4"}, "Das brauchst du nicht..."));
                questionMap.put(8, new Question("Rechnerarchitektur", "Vor Sekretariat","Welche Zahlen müssen oben eingegeben werden, damit die Lampe am Ende aufleuchtet.", new String[]{"1111"}, "Es enthält mindestens 3x die 1"));
            ...
            case 7:
                ...
                questionMap.put(6, new Question("Big Data", "Eingang Neubau","Max ist auf der Suche nach einem neuen Film. Welcher könnte ihm gefallen? Die Anfangsbuchstaben von einem der vier Namen kombiniert mit den beiden Filmen (als Buchstabe), die Max gefallen könnten, ergibt den Namen eines Produzenten, der Filme herstellt, welche Max ebenfalls gefallen könnte.", new String[]{"Marvel"}, "Die zwei Buchstaben, welche die beiden Filme repräsentieren, die Max gefallen könnten gehören zu den letzten beiden Buchstaben des Wortes."));
                ...
                questionMap.put(8, new Question("Verschlüsselung", "Vor Sekretariat","Was ist der Klartext dieser Verschlüsselung?", new String[]{"Klabautermann"}, "Binärzahl in Zahl umwandeln, um in der Tabelle zu schauen"));
                questionMap.put(9, new Question("Objektorientierung", "Bei Selectaautomaten (EG)","Beantworte die Fragen auf dem Blatt?", new String[]{"Kette"}, "Der letzte Buchstaben des Lösungsworts ist ein 'E'"));
                questionMap.put(10, new Question("Netzwerke", "Tür zum Innenhof (Neben FS-Zimmer Musik)","Auf welcher Portnummer können normalerweise Webseiten verschlüsselt abgerufen werden?", new String[]{"443"}, "Es ist eine dreistellige Zahl..."));
