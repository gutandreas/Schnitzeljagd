    ...
    public static void addQuestionsToMap(int modus){
        ...
        switch (modus){
            case 1:
                ...
                questionMap.put(1, new Question("turnhalle","Wie heisst der Physiker Einstein mit Vorname?", new String[]{"Albert"}, "Er beginnt mit 'A'", "Haupteingang"));
            ...
            case 2:
                ...
                questionMap.put(1, new Question("turnhalle","Wie heisst Trump mit Vorname?", new String[]{"Donald"}, "Er beginnt mit 'D'", "Haupteingang"));
                questionMap.put(2, new Question("haupteingang", "Wie heisst der Rektor mit Vorname?", new String[]{"Ueli", "Ulrich"}, "Er beginnt mit 'U'", "Sekretariat"));
                questionMap.put(3, new Question("sekretariat","Wie heisst Bundesrat Berset mit Vorname?", new String[]{"Alain"}, "Er beginnt mit 'A'", "Aula"));
                break;
        }
